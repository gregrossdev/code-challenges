...
|-------|---------|-------|------------|--------|
| 2.1 | `0.2.1` | Module scaffold, data model & test fixtures | in-session | pending |
| 2.2 | `0.2.2` | Lexer implementation & tests | in-session | pending |
| 2.3 | `0.2.3` | Parser implementation & tests | in-session | pending |
| 2.4 | `0.2.4` | CLI, native image & integration tests | in-session | pending |
| 2.5 | `0.2.5` | JSON parser article write-up | in-session | pending |
