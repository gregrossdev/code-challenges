...
|-------|---------|-------|------------|--------|
| 1.1 | `0.1.1` | Gradle monorepo scaffolding & article template | in-session | done |
| 1.2 | `0.1.2` | wc tool implementation & tests | in-session | done |
| 1.3 | `0.1.3` | wc challenge article write-up | in-session | done |
| 1.4 | `0.1.4` | GraalVM native image support | in-session | done | [UNPLANNED] |
